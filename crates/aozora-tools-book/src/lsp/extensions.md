...
chapters are the wire contract; changes are flagged in `CHANGELOG.md`
(additive under **Changed**, breaking under **Removed**) with the
affected method name called out.
